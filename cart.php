                        ...
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" class="inventory_id" name="inventory_id" value="<?= $row['inventory_id'] ?>">
...
<script>
    ...
    function qty_change($type,_this){
        ...
        var inventory_id = _this.closest('.cart-item').find('.inventory_id').val();
        var new_total = 0;
        start_loader();
        if($type == 'minus'){
        ...
        $.ajax({
            ...
            method:'POST',
            data:{id:cart_id, quantity: qty, changeType: $type, inventory_id: inventory_id},
            dataType:'json',
            error:err=>{
                console.log(err)
