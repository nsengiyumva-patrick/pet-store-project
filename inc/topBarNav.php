            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=veterinary services">veterinary services </a></li>
                        ...
                        <a class="text-dark mr-2 nav-link" href="./?p=cart">
                            ...
                            <span class="badge bg-dark text-white ms-1 rounded-pill" id="cart-count">
                              ...
                              if(isset($_SESSION['userdata']['id'])):
                                $count = $conn->query("SELECT SUM(quantity) as items from `cart` where client_id =".$_settings->userdata('id'));
                                $count = $count ? $count->fetch_assoc()['items'] : 0;
